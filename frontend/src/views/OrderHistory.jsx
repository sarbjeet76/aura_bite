                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                      ...
                      <strong>Delivery Address:</strong> {order.deliveryAddress ? `${order.deliveryAddress.street}, ${order.deliveryAddress.city}, ${order.deliveryAddress.state} - ${order.deliveryAddress.pincode}${order.deliveryAddress.landmark ? ` (Landmark: ${order.deliveryAddress.landmark})` : ''} | 📞 Phone: ${order.deliveryAddress.phone || 'N/A'}` : 'N/A'}
                    </p>
